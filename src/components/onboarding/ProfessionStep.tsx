    ...
    <div className="card-glass w-full max-w-md rounded-2xl border border-white/10 px-6 py-8 shadow-2xl shadow-black/20 sm:px-8 sm:py-10">
      ...
      <div className="mt-8 flex gap-3">
        ...
        <button
          ...
          disabled={!value}
          onClick={onContinue}
          className="flex flex-1 items-center justify-center gap-2 rounded-full bg-white py-3.5 font-sans text-base font-bold text-zinc-900 transition-opacity hover:opacity-90 disabled:opacity-50"
        >
          {continueLabel}
