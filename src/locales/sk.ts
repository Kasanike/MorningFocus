...
export const sk: LocaleKeys = {
  ...
  stoic_oracle_aria: "Zapamätaj si to dnes — v súvislosti s tvojím záväzkom",
  quote_remember_today: "Zapamätaj si to dnes.",
  quote_title: "Citát",
  ...
  keystone_placeholder: "Vaša priorita na dnes…",
  keystone_lock_button: "Uzamkni to.",
  keystone_todays_commitment: "Záväzok na dnes",
  keystone_locked_badge: "✓ Uzamknuté",
