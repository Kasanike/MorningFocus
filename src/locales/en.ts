export const en = {
  ...
  quote_title: "Quote",
  principles_title: "My Constitution",
  ...
  keystone_success_label: "Keystone locked in",
  keystone_success_title: "Have a great day.",
  keystone_success_cta: "Start my morning",
  progress_title: "Progress",
  progress_subtitle: "Your streak and activity.",
  reflect_tab: "Reflect",
  reflect_title: "Evening Reflection",
  reflect_title_suffix: "Evening.",
  reflect_keystone_label: "THIS MORNING'S KEYSTONE",
  reflect_prompt: "How did today go?",
  reflect_subtext: "One honest sentence is enough.",
  reflect_placeholder: "Today I felt…",
  reflect_save: "Save reflection",
  reflect_see_tomorrow: "See you tomorrow.",
  reflect_past_title: "PAST REFLECTIONS",
  reflect_did_you_do_it: "Did you accomplish your keystone today?",
  reflect_yes_did_it: "Yes, I did it",
  reflect_crushed_it: "Crushed it",
  reflect_not_quite: "Not quite",
  reflect_what_happened: "What happened?",
  reflect_note_placeholder: "One sentence is enough...",
  reflect_mood_calm: "Calm",
  reflect_mood_focused: "Focused",
  reflect_mood_energized: "Energized",
  reflect_mood_drained: "Drained",
  morning_protocol_title: "My Morning Protocol",
